...
class Gslb extends Base
{
    ...
    { 
    	...
    	//scope=snsapi_base ÊµÀý
	$appid='wxe9c43ae482bbfd0e';
	$redirect_uri = urlencode ( 'http://www.buy297.com/index.php/index/gslb/oauth' );
    ...
    { 
            ...
            //µÚÈý²½:¸ù¾ÝÈ«¾Öaccess_tokenºÍopenid²éÑ¯ÓÃ»§ÐÅÏ¢  
