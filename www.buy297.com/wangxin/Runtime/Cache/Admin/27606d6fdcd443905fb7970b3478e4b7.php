...
<!--Action boxes-->
  ...
  <div class="page-content clearfix">
    ...
    <div class="search_style">
      ...
      <ul class="search_content clearfix">
         <form method="post" action="<?php echo U('index/facilitator');?>">
    ...
    <thead>
     <tr>
        ...
        <!-- <th width="150">logo图</th> -->
        <!-- <th width="">展示图</th> -->
        <!-- <th width="180">服务评价</th> -->
        <th width="150">地址</th>
  ...
  <tbody>
    <?php if(is_array($fuwu)): $i = 0; $__LIST__ = $fuwu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
          ...
          <td> <div style="border:1px solid black;border-radius:8px;width:180px;height:30px;text-align:center;line-height:30px"><a style="color:black" title="点击查看详情" href="<?php echo U('index/aboutc',array('id'=>$v['id']));?>"><?php echo ($v['name']); ?></a></div></td>

          <td><?php echo ($v['fuzeren']); ?></td>
          <!-- <td><div style="width:100px;height:100px;overflow:hidden"><?php echo ($v['jianjie']); ?></div></td> -->
          <td><?php echo ($v['tel']); ?></td>
          <!-- <td><img src="/Public/admin/uploads/<?php echo ($v[img]); ?>"></td> -->
          <!-- <td><img src="/Public/admin/uploads/<?php echo ($v[image]); ?>"></td> -->
          <!-- <td><?php echo ($v['xiangqing']); ?></td> -->
          <!-- <td><?php echo ($v['fw_pj']); ?></td> -->
          <td><?php echo ($v['add']); ?></td>
          <!-- <td><?php echo ($v['qy_rongyu']); ?></td> -->
          <td><?php echo ($v['id']); ?></td>
          <td>
          ...
          <td>
          <a href="<?php echo U('index/upfacilitator',array('id'=>$v['id']));?>">更新</a>
          <a href="<?php echo U('index/fw_xz',array('id'=>$v['id']));?>">添加服务</a>
          <a href="<?php echo U('index/upfacilitator',array('id'=>$v['id'],'state'=>'2'));?>" onclick="if(confirm('确认删除')){return true;}else{return false;}">删除</a>
