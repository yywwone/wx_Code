  ...
  <div class="page-content clearfix">
    ...
    <div class="search_style">
     ...
     <div class="border clearfix">
       ...
       <span class="r_f" style="float:left">共：<b><?php echo ($count); ?></b>条</span>
     </div>
     <!---->
      ...
      <?php if(is_array($con)): $i = 0; $__LIST__ = $con;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><td><?php echo ($v['id']); ?></td>
          ...
          <?php switch($v['zhuangtai']): case "0": ?><td class="text-l">
                <div style="width:100px;height:30px;border:1px solid #ccc; border-radius:5px;margin:0 auto;">
                  <a href="<?php echo U('Complain/fuwustate',array('id'=>$v['id']));?>" title="点击通过" style="line-height:30px;">已下单</a>
                </div>
             </td><?php break;?>
            <?php case "1": ?><td class="text-l">进行中</td><?php break;?>
            <?php case "2": ?><td class="text-l">已完成</td><?php break;?>
            <?php case "3": ?><td class="text-l">已评价</td><?php break; endswitch;?>
